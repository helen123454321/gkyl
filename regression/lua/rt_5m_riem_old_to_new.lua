...
-- This si really Helens repication of Petrs "gkyl-paper-inp/2017_PoP_sheaths/TeTi_010_00/5m.lua" file.

local Moments = G0.Moments
local Euler = G0.Moments.Eq.Euler

-- Physical constants (using normalized code units).
gas_gamma = 5.0/ 3.0 -- Adiabatic index. D
mu0 = 1.0/100 -- Permeability of free space. D
epsilon0 = 1.0 --Permeability of free space. D
mass_ion = 1836.2-- proton mass. D

charge_ion = 1.0 -- Proton charge. D
mass_elc = 1.0 -- Electron mass. D
charge_elc = -1.0 -- Electron charge. D
...
has_collision = false -- Whether to include collisions. D?
