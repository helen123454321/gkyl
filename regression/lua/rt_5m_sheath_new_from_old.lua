-- 5M sheath with Poisson field solver
-- New appoch! Try to fix the old gyke code to now stuff

-- Import from Chat Imports stuff 
local Grid = require "Gkyl.Grid.RectCart1D"
local DataStruct = require "Gkyl.Data.Field1D"
local Basis = require "Gkyl.Vlasov.Basis"
local EulerEqn = require "Gkyl.Hyper.Eqn.Euler"
local Poisson = require "Gkyl.Hyper.Updater.Poisson1D"
local Logger = require "Gkyl.Logger"
-- recomented from documention 
...
gasGamma = 5.0/3
Te_Ti = 10.0 -- ratio of electron to ion temperaute
